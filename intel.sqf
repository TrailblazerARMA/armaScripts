...
// false,  
// false  
// ] remoteExec ["BIS_fnc_holdActionAdd", 0, folder1]; canOpen = false; publicVariable "canOpen";

//Do NOT copy into init below this line
//EDIT THE SETTING BELOW TO YOUR LIKING
_mPic1 = "terminal.jpg";//define path to picture 1 
_p1Txt = "This is my text example";//set picture 1 text
_mPic2 = "terminal.jpg";//define the path to picture 2
